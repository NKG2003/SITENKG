  ...
  <section class="text-black body-font h-screen">
    <div class="container px-5 py-40 mx-auto ">
      ...
      >
        <div class="p-2">
          <div
            class="h-full bg-gray-100/80 rounded-lg px-8 pt-10 pb-10 overflow-hidden text-center relative"
          >
            <h1
              class="bg-gray-100/80title-font sm:text-2xl text-xl font-medium text-black mb-3"
            >
              Документ
            </h1>
        ...
        <div class="p-2">
          ...
          >
            <h1
              class="title-font sm:text-2xl text-xl font-medium text-black mb-3"
            >
              Документ
            </h1>
        ...
        <div class="p-2">
          <div
            class="h-full bg-gray-100/80 rounded-lg px-16 pt-10 pb-10 overflow-hidden text-center relative"
          >
            <h1
              class="title-font sm:text-2xl text-xl font-medium text-black mb-3"
            >
